/* ============================================================
 RAHMA ISLAMIC CENTRE — shared.js v5 (sanitized)
 Notes:
  - Corrige les caractères parasites (\, etc.)
  - Renforce la tolérance aux erreurs pour éviter de bloquer les pages
============================================================ */
...
function toggleMobile(){
  ...
  if (mm) mm.classList.toggle('active', mobileOpen);
  if (hb) hb.classList.toggle('active', mobileOpen);
...
function _addMins(timeStr, mins){
  ...
  var total = parts[0]*60 + (parts[1]||0) + (mins||0);
